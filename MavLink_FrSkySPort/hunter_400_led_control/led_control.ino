...
#define SIDE  5
#define FLASH  6
int  LED_DEF[NUM_ARMS][NUM_LEDS_PER_STRIP] = {{ARMED,ARMED,ARMED,ARMED,ARMED,ARMED,ARMED,ARMED,ARMED,ARMED,ARMED,ARMED,ARMED,ARMED,ARMED,ARMED,     GPS,   GPS,   GPS,   GPS,   GPS,       ARMED,ARMED,  ARMED, ARMED, ARMED, ARMED, ARMED, ARMED, ARMED, ARMED, ARMED, ARMED, ARMED, ARMED, ARMED,ARMED,  GPS,GPS,GPS,GPS,GPS,GPS,GPS,GPS,GPS,GPS,GPS,GPS, GPS },
